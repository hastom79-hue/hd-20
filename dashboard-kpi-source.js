...
window.HD20KPIData={KEY,HEADCOUNT_KEY,load,yearOf,selectedYear,isCandidate,isConfirmed,isMaintained,isAdvancementType,rowDate,confirmedDate,headcount,snapshot,signal};
