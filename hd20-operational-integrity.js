...
window.HD20_OPERATIONAL_INTEGRITY={seoulDate,overdue,effectVerified,recurrence,completedVerified,completedRecurrence,run};document.readyState==='loading'?document.addEventListener('DOMContentLoaded',bind,{once:true}):bind();
})();