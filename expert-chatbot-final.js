...
const FAQ=[
  ...
  ['고도화 후보는 어떻게 공식 확정되나요?','현장 등록은 실적이 아닙니다. 생산혁신팀·5S 모듈이 3대 기준 중 2개 이상 충족 여부를 판정해 「확정/보완요청/미확정」으로 나누고, 확정된 사례만 수준맵·KPI에 반영됩니다.'],
...
function answer(q){
  ...
  if(/후보|판정|확정|고도화/.test(t))return['고도화 사례 판정','현장 등록 자체는 실적이 아닙니다. 생산혁신팀·5S 모듈이 시각화·형적관리, 인간공학적 Green Zone, 정량축소·정위치 변경 3대 기준 중 2개 이상을 충족했는지 확인하고 확정한 사례만 공식 실적과 수준맵에 반영합니다.','등록→판정→확정','3대 기준','수준맵'];
