...
function render(){
  ...
  host.insertAdjacentHTML('beforeend',`<div class="awGrid">
    ...
    ${`<div class="awCard"><div class="awHead">5S 개선활동 목표 (분기, 인당 개선건수 기준) · 활동유형</div><div class="awBody">
  ...
  <div class="awCard" style="margin-top:12px"><div class="awHead">5S 고도화 확정 목표 (분기, 3대 기준 충족 사례 기준 · 절대 건수)</div><div class="awBody">
