(()=>{const ID='hd20FinalLayoutPolish';document.getElementById(ID)?.remove();const s=document.createElement('style');s.id=ID;s.textContent=`
...
.approvedFramework .afCard b{grid-column:2!important;grid-row:1!important;margin:0!important;padding:0!important;font-size:12.4px!important;line-height:1.28!important;color:#173a57!important;white-space:normal!important;word-break:keep-all!important}
.approvedFramework .afCard p{grid-column:2!important;grid-row:2!important;margin:2px 0 0!important;font-size:10px!important;line-height:1.32!important;color:#6d8291!important;white-space:normal!important;word-break:keep-all!important}
...
function reorder(){const fw=document.querySelector('.approvedFramework'),raw=document.querySelector('.approvedRaw'),analysis=document.querySelector('.approvedAnalysis');if(!fw||(!raw&&!analysis))return false;const anchor=raw||analysis;if(anchor.nextElementSibling!==fw)anchor.insertAdjacentElement('afterend',fw);return true}
function boot(){let n=0;const run=()=>{if(reorder())return;if(++n<30)setTimeout(run,120)};run()}
